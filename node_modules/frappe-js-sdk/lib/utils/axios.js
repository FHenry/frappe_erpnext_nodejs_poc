...
function getAxiosClient(appURL, useToken, token, tokenType, URLHost) {
    return axios_1.default.create({
        baseURL: appURL,
        headers: getRequestHeaders(useToken, tokenType, token, URLHost),
        withCredentials: true,
    });
}
exports.getAxiosClient = getAxiosClient;
function getRequestHeaders(useToken, tokenType, token, URLHost) {
